...
export default function Ethos() {
  ...
  const bentoCardHover = "group hover:bg-luxury-charcoal/40 hover:border-luxury-gold/30 transition-all duration-700";
    ...
    <section className="relative py-24 md:py-40 px-6 bg-luxury-black overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-[1440px] mx-auto relative z-10 lg:px-12">
        ...
        >
          ...
          {/* ─── Left Column: Manifesto & Typographic Core (5 Columns) ─── */}
          <div className="lg:col-span-5 relative">
            ...
            <motion.div variants={fadeUp} className="relative z-10 flex items-center gap-4 mb-8">
            ...
            <motion.h2 variants={fadeUp} className="relative z-10 font-heading text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-white leading-[0.95] tracking-tight font-light mb-8 drop-shadow-lg">
              Bespoke <br />
              <span className="text-luxury-gold italic">Aesthetic</span> <br />
              Mastery.
            </motion.h2>
            
            <motion.p variants={fadeUp} className="relative z-10 font-sans text-lg md:text-xl text-gray-400 font-light leading-relaxed mb-10 max-w-md">
              At Calixta, we don&apos;t just adapt to current trends—we define them. Our approach marries global luxury standards with deep aesthetic intuition to curate styles that are flawlessly executed.
            </motion.p>
          ...
          {/* ─── Right Column: The Architectural Bento Grid (7 Columns) ─── */}
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
            
            {/* Top Left Bento Text Card */}
            <motion.div variants={fadeUp} className={`col-span-1 p-8 md:p-10 border border-white/5 bg-[#0a0a0c] relative overflow-hidden flex flex-col justify-center min-h-[240px] md:min-h-[280px] ${bentoCardHover}`}>
              ...
              <div className="text-[9px] uppercase tracking-widest text-gray-600 font-sans mb-4 group-hover:text-luxury-gold/70 transition-colors">Global Standard</div>
              <h3 className="font-heading text-2xl md:text-3xl text-white font-light mb-4 group-hover:text-luxury-gold transition-colors duration-500">Global Artistry</h3>
            ...
            <motion.div variants={fadeUp} className={`col-span-1 p-8 md:p-10 border border-white/5 bg-[#0a0a0c] relative overflow-hidden flex flex-col justify-center min-h-[240px] md:min-h-[280px] ${bentoCardHover}`}>
              ...
              <div className="text-[9px] uppercase tracking-widest text-gray-600 font-sans mb-4 group-hover:text-luxury-gold/70 transition-colors">Atmosphere</div>
              <h3 className="font-heading text-2xl md:text-3xl text-white font-light mb-4 group-hover:text-luxury-gold transition-colors duration-500">Exclusive Sanctuary</h3>
              <p className="font-sans text-sm text-gray-500 leading-relaxed font-light">
                The premier destination for elite clientele in Prayagraj, offering unparalleled privacy and personalized service.
              </p>
            </motion.div>

            {/* Right Tall Cinematic Image Card (Spans 2 Rows on Tablet/Desktop) */}
            <motion.div 
              variants={fadeUp} 
            ...
            >
              ...
              />
              {/* Luxury Vignette to blend image into the dark layout */}
              ...
              {/* Optional Text inside image on hover */}
              <div className="absolute bottom-8 left-8 z-30 opacity-0 group-hover:opacity-100 transition-opacity duration-700 translate-y-4 group-hover:translate-y-0">
                 <span className="font-heading text-2xl text-white font-light italic">Precision & Care</span>
              </div>
            </motion.div>
